...
<main class="container my-5">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="image" class="form-label">Current Fetured Image</label></br>
            <img class="img-fluid mb-2" style="width: 200px" src="<?php echo htmlspecialchars($articleData->image); ?>" alt="">
        </div>
