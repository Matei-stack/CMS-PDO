...
document.getElementById('deleteSelectedBtn').onclick = function(){
    ...
    if(selectedIds.length === 0 ){
        alert("Selecteaza cel putin un articol");
        return;
    }

    if(confirm("esti sigur ca vrei sa stergi acest articol")){
    ...
    document.querySelectorAll('.delete-single').forEach((button)=>{
        button.onclick = function(){
            ...
            if(confirm("esti sigur ca vrei sa stergi acest articol " + articleId + '?')){
